...
export default function BackgroundBalls() {
  ...
  // Lower durations => faster motion. Tune per-page if needed.
  const ballDurations = [12, 14, 10, 11];
  ...
  const particleDurations = [9, 8, 10, 9, 9, 10, 8, 9];
  const particleDelays = [0, 0.25, 0.5, 0.75, 0.3, 0.4, 0.2, 0.35];
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        {ballPositions.map((pos, i) => (
          <motion.div
            ...
            style={{ left: pos.left, top: pos.top, background: 'linear-gradient(45deg, #F24DC2, #2C97FF)' }}
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        {particlePositions.map((pos, i) => (
          <motion.div
            ...
            style={{ left: pos.left, top: pos.top, background: 'linear-gradient(90deg, #F24DC2, #2C97FF)' }}
