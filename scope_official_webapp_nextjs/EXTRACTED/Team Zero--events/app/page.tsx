  ...
  return (
    <div className="min-h-screen bg-[#040A28] text-gray-200 font-sans relative overflow-hidden">
      ...
      <header className="flex justify-between items-center py-4 px-8 relative">
        <div className="absolute bottom-0 left-0 w-full h-[1px] bg-gradient-to-r from-[#EC4DC2] via-[#0072FF] to-[#040A28]"></div>
        ...
        <nav className="space-x-8 text-lg">
          <a href="#" className="font-dm-sans hover:text-blue-400 transition-colors text-24px">Home</a>
          <a href="#" className="font-dm-sans hover:text-blue-400 transition-colors text-24px">Events</a>
          <a href="#" className="font-dm-sans hover:text-blue-400 transition-colors text-24px">About Us</a>
          <a href="#" className="font-dm-sans hover:text-blue-400 transition-colors text-24px">Team</a>
          <a href="#" className="font-dm-sans hover:text-blue-400 transition-colors text-24px">FAQ</a>
        </nav>
      </header>
      ...
      <main className="container mx-auto px-8 py-16 lg:py-24">
        ...
        <section className="flex flex-col lg:flex-row items-center lg:items-start justify-between mb-24">
          <div className="lg:w-1/2 pr-8 mb-12 lg:mb-0">
            ...
            <div className="font-dm-sans text-xl">
              ...
              <h3 className="text-xl font-semibold mb-3 text-blue-300">Key Ambitions</h3>
        ...
        {/* Footer Section */}
        <footer className="text-center py-16 relative flex flex-col items-center justify-center">
          <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-[#EC4DC2] via-[#0072FF] to-[#040A28]"></div>
          <div className="flex items-center justify-center w-full mb-6">
            <div className="flex-grow h-px bg-white max-w-[150px]"></div>
            <span className="mx-4 text-white text-dmSansLink text-28px whitespace-nowrap">
              Connect with us
            </span>
            <div className="flex-grow h-px bg-white max-w-[150px]"></div>
          </div>
          <div className="flex justify-center space-x-20 text-3xl">
            <a href="#" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">
              <img src="/images/instagram-icon.png" alt="Instagram" className="h-[63px] w-[63px]" />
            </a>
            <a href="#" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">
              <img src="/images/x-icon.png" alt="X (Twitter)" className="h-[61px] w-[61px]" />
            </a>
            <a href="#" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">
              <img src="/images/linkedin-icon.png" alt="LinkedIn" className="h-[63px] w-[63px]" />
            </a>
          </div>
        </footer>
      </main>
